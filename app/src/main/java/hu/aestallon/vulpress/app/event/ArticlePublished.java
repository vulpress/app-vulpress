...
public class ArticlePublished extends ApplicationEvent implements UserEvent {

  private final User publishedBy;

  public ArticlePublished(Article article, User user) {
    super(article);
    this.publishedBy = user;
  }

  public ArticlePublished(Article article) {
    this(article, null);
  }
